...
const TaskCard = () => {
  return (
    ...
    >
      <header>
        <h1 className="text-lg font-medium">タイトル</h1>
      ...
      <div>
        ...
        <div className="flex justify-between items-center">
          <div
            className={`tm-1 text-sm px-2 py-1 w-24 text-center text-white rounded-full
             shadow-sm ${true ? "bg-green-500" : "bg-red-500"}`}
          >
